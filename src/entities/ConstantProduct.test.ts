...
import { USDC_ADDRESS, WETH9, WETH9_ADDRESS } from '../constants'
...
describe('ConstantProductPool', () => {
  ...
  describe('#getAddress', () => {
    it('returns the correct address', () => {
      expect(ConstantProductPool.getAddress(USDC, DAI)).toEqual('0x03Aa826E74e223ec6E5a425EB4f925E71084392d')
    })
  })
